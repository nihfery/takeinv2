import { BadgeCheck, Ellipsis, Eye, LockKeyhole, Mail, Pencil, Store, UserRoundX } from "lucide-react";
...
export function ProfileHeader({ editLabel, profile, onEdit }: ProfileHeaderProps) {
  return (
    <div className="flex flex-col gap-5 px-4 lg:flex-row lg:items-end lg:justify-between">
      <div className="flex min-w-0 items-center gap-4">
        <div className="grid size-18 shrink-0 place-items-center sm:size-23">
          <span className="sr-only">Profile {profile.completionPercentage}% complete</span>
        ...
        <div className="flex min-w-0 flex-col gap-2">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Badge className="rounded-sm bg-green-600 text-white" variant="default">
              ...
              {profile.verified ? "Verified" : profile.verificationStatus}
            </Badge>
