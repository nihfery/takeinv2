...
CREATE INDEX media_outbox_claim_idx ON outbox_events(occurred_at) WHERE published_at IS NULL AND locked_at IS NULL;
-- +goose Down
DROP INDEX IF EXISTS media_outbox_claim_idx;
